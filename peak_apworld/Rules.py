...
def apply_rules(world: "PeakWorld"):
    ...
    acquire_locations = [
        ...
        "Acquire Cure-All", "Acquire Faerie Lantern", "Acquire Ancient Effigy",
        "Acquire Cursed Skull", "Acquire Pandora's Lunchbox", "Acquire Bugle of Friendship",         "Acquire Bugle", "Acquire Remedy Shroom",
