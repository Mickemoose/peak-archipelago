...
item_groups: typing.Dict[str, typing.List[str]] = {
    ...
    "Movement":         ["Rope Spool", "Rope Cannon", "Anti-Rope Spool", "Anti-Rope Cannon", 
                         "Chain Launcher", "Piton", "Magic Bean", "Parasol", "Balloon", 
                         "Balloon Bunch", "Scout Cannon", "Flying Disc", "Rescue Claw"],
    "Healing":          ["Bandages", "First-Aid Kit", "Antidote", "Heat Pack", "Cure-All",
                         "Remedy Fungus", "Medicinal Root", "Aloe Vera", "Sunscreen",
                         "Marshmallow", "Glizzy", "Fortified Milk"],
    "Mushrooms":        ["Shelf Shroom", "Bounce Shroom", "Button Shroom", "Bugle Shroom",
                         "Cluster Shroom", "Chubby Shroom", "Cloud Fungus"],
    "Berries":          ["Red Crispberry", "Green Crispberry", "Yellow Crispberry",
                         "Orange Winterberry", "Yellow Winterberry", "Red Prickleberry",
                         "Gold Prickleberry", "Brown Berrynana", "Blue Berrynana",
                         "Pink Berrynana", "Yellow Berrynana"],
    "Shroomberries":    ["Red Shroomberry", "Blue Shroomberry", "Yellow Shroomberry",
                         "Green Shroomberry", "Purple Shroomberry"],
}